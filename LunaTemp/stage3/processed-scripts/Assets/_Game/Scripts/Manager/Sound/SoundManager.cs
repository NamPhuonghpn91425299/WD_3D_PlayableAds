...
public class SoundManager : Singleton<SoundManager>
{
    ...
    public static void PlaySound([Bridge.Ref] SoundDefine sound)
    {
    ...
    public static void StopSound([Bridge.Ref] SoundDefine sound)
    {
        if (sound.Clip == null) return;
        switch (sound.soundType)
        {
    ...
    public static void PlayRandomBGM([Bridge.Ref] SoundDefine sound)
    {
