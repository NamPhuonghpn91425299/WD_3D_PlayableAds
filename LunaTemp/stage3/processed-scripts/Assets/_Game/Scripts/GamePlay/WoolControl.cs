...
if (BoxCollider == null)
{
    ...
    public bool PushColor([Bridge.Ref] Color color)
    {
    ...
    public void DisplayColor([Bridge.Ref] Color albedo)
    {
        if (MeshObjectData == null) return;
    ...
    private static bool PointInTriangle([Bridge.Ref] Vector3 p, [Bridge.Ref] Vector3 v0_, [Bridge.Ref] Vector3 v1_, [Bridge.Ref] Vector3 v2_)
    {
    ...
    private static Vector3 ClosestPointOnSegment([Bridge.Ref] Vector3 p, [Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b)
    {
